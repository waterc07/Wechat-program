...
DEFAULT_ASSISTANT_QUESTIONS = {
    ...
    "en-US": (
        "To help the doctor understand your situation more quickly, please add the symptom duration, severity, "
        "and whether you also have fever, cough, worsening pain, or other discomfort."
    ),
}
